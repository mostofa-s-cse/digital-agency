...
const portfolio = [
  ...
  },
  {
    ...
    image: 'https://mdbcdn.b-cdn.net/img/Photos/Horizontal/Nature/4-col/img%20(75).webp',
    link: "#"
  },
  {
    title: 'A old job',
    ...
    image: 'https://mdbcdn.b-cdn.net/img/Photos/Horizontal/Nature/4-col/img%20(74).webp',
    link: "#"
  },
  {
    ...
    name: 'Lorem ipsum is simple dummy text on the printing and typesetting industry.',
    category: ['all', 'frontend', 'ux-ui'],
    image: 'https://mdbcdn.b-cdn.net/img/Photos/Horizontal/Nature/4-col/img%20(70).webp',
    link: "#"
  },
  {
    ...
    name: 'Lorem ipsum is simple dummy text on the printing and typesetting industry.',
    category: ['all', 'others'],
    image: 'https://mdbcdn.b-cdn.net/img/Photos/Horizontal/Nature/4-col/img%20(72).webp',
    link: "#"
  },
];
  ...
  return (
    <>
      ...
      <header id="home" className="w-full">
        <div className="overlay w-full text-center py-48 px-4">
          <h2 className="font-bold text-white text-[3em] uppercase">
            <span>IT Solution</span>
            <br />
            <span className="text-red-600">for</span>
            <br />
            <span>Your Business</span>
          </h2>
          <div
            className="flex gap-14 mt-8"
      ...
      >
        <div className="container grid lg:grid-cols-2 gap-12 md:grid-cols-1 justify-between py-16">
          <div className="w-full">
            ...
            Piusto odio dignissimos ducimus qui blanditiis praesentium voluptatum del eniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia.
              <br />
              <br /> Mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facil est et expedita distinctio. Nam libero tempore, cum soluta nobis esteligendi optio cumque nihil impedit quo minus id quod maxime.
            </p>
        ...
        <div className="container mx-auto py-16">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              ...
              <h2 className="text-[#f11b1b] font-bold text-[2.5em] uppercase">
                <span className="text-white">WE DO AWESOME</span> DESIGN & CODE
              </h2>
              <div className="flex mt-2">
                <div
      ...
      <section id="features" className="bg-white">
        <div className="container mx-auto py-16 text-center">
          <h2 className="text-[#232044] font-bold text-[2.5em] uppercase">
            BEST FEATURES
          </h2>
          ...
          <div className="mx-auto px-4">
            <div className="-mx-4 flex flex-wrap mt-8">
              <div className="px-4 md:w-1/2 lg:w-1/3">
                <div className="features_card hover:bg-[#232044] hover:text-white shadow-md" style={{ padding: "40px" }}>
      ...
      {/* -- ====== FEATURES Section End -- */}
       ...
       <section className="text-gray-700 text-center">
        <div className="container mx-auto py-16">
          ...
          <p className="py-5">
            Piusto odio dignissimos ducimus qui blanditiis praesentium voluptatum cati cupiditate non provident, similique sunt in culpa qui.
          </p>

          <div className="text-center mb-8 mt-8 text-[#f83256]">
            <button onClick={() => setFilter('all')} className="inline-flex items-center justify-center p-0.5 mb-2 mr-2 text-sm font-medium rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
              <span className="px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                All
              </span>
            </button>
            <button onClick={() => setFilter('frontend')} className="inline-flex items-center justify-center p-0.5 mb-2 mr-2 text-sm font-medium rounded-lg group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-cyan-200 dark:focus:ring-cyan-800">
              <span className="px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                Frontend
              </span>
            </button>
            <button onClick={() => setFilter('mobile')} className="inline-flex items-center justify-center p-0.5 mb-2 mr-2 text-sm font-medium rounded-lg group bg-gradient-to-br from-green-400 to-blue-600 group-hover:from-green-400 group-hover:to-blue-600 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800">
              <span className="px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                Mobile
              </span>
            </button>
            <button onClick={() => setFilter('ux-ui')} className="inline-flex items-center justify-center p-0.5 mb-2 mr-2 text-sm font-medium rounded-lg group bg-gradient-to-br from-purple-500 to-pink-500 group-hover:from-purple-500 group-hover:to-pink-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800">
              <span className="px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                UX/UI
              </span>
            </button>
            <button onClick={() => setFilter('others')} className="inline-flex items-center justify-center p-0.5 mb-2 mr-2 text-sm font-medium rounded-lg group bg-gradient-to-br from-pink-500 to-orange-400 group-hover:from-pink-500 group-hover:to-orange-400 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800">
              <span className="px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                Others
              </span>
            </button>
                  ...
                  <div className="card">
                    ...
                    <div className="details overflow-hidden">
                      <div className="center" key={item.title}>
                        <h1>{item.title}</h1>
                        <p>{item.name}</p>
                        <a href={item.link} type="button" className="mt-4 inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium rounded-lg group bg-gradient-to-br from-pink-500 to-orange-400 group-hover:from-pink-500 group-hover:to-orange-400 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800">
                          <span className="px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                            Visite Site
                          </span>
                        </a>
        ...
        <div className="counterBenner w-full mt-8 mb-8">
          <div className="overlay w-full mx-auto text-center text-white py-28 px-4">
            <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
              <Counter number={105} CountIcon={CounerImage1} title="Satisfied Clients" />
              <Counter number={5175} CountIcon={CounerImage2} title="Users Loved" />
              <Counter number={468} CountIcon={CounerImage3} title="Project Complated" />
              <Counter number={468} CountIcon={CounerImage4} title="Cup Coffe" />
            </div>
          </div>
        </div>
      </section>
                ...
                <div className="relative overflow-hidden rounded-lg">
                  ...
                  <div className="absolute bottom-5 left-0 w-full text-center">
                    ...
                    >
                      ...
                      <p className="text-body-color text-sm mb-3">Web Developer</p>
                ...
                <div className="relative overflow-hidden rounded-lg">
                  ...
                  <div className="absolute bottom-5 left-0 w-full text-center">
                    ...
                    >
                      ...
                      <p className="text-body-color text-sm mb-3">App Developer</p>
                      <ul className="flex place-content-center space-x-4 sm:mt-0">
                        <li>
                          <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" /></svg>
                ...
                <div className="relative overflow-hidden rounded-lg">
                  ...
                  <div className="absolute bottom-5 left-0 w-full text-center">
                    ...
                    >
                      ...
                      <p className="text-body-color text-sm mb-3">UI/UX Designer</p>
                      <ul className="flex place-content-center space-x-4 sm:mt-0">
                        <li>
                          <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" /></svg>
                ...
                <div className="relative overflow-hidden rounded-lg">
                  ...
                  <div className="absolute bottom-5 left-0 w-full text-center">
                    ...
                    >
                      ...
                      <p className="text-body-color text-sm mb-3">Sales Manager</p>
                      <ul className="flex place-content-center space-x-4 sm:mt-0">
                        <li>
                          <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" /></svg>
          ...
          <div class="-mx-4 flex flex-wrap lg:justify-between">
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div class="mb-12 max-w-[570px] lg:mb-0 px-4">
                <h2
                  class="text-[32px] text-[#232044] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
                >
              ...
              <div className="w-full px-4">
                <iframe class="w-full" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3746841.1351297237!2d88.10015636820113!3d23.495625356900998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30adaaed80e18ba7%3A0xf2d28e0c4e1fc6b!2sBangladesh!5e0!3m2!1sen!2sbd!4v1673108930917!5m2!1sen!2sbd" height="200"></iframe>
              </div>
            </div>
